# Email #2 — The CEO Conversation After a Failed EMC Test
...
## Notes
- Subject line names EMC explicitly — passes Avatar B 2-second test
- TL;DR block gives three concrete, actionable points first-pass teams use
- No pricing in body — CTA links to the page
- P.S. reframes fear of the audit as the reason to do it
- Humanizer applied: no em dashes, no AI vocabulary, short punchy sentences mixed with longer ones
